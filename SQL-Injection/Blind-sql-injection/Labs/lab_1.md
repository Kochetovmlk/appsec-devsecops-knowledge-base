...
Результаты SQL-запроса не возвращаются, и сообщения об ошибках не отображаются. Однако приложение отображает Welcome backсообщение на странице, если запрос возвращает какие-либо строки.

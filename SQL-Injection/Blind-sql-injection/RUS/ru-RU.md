...
Первый из этих входных сигналов не вызывает задержку, поскольку условие `1=2ложно`.
Второй входной сигнал вызывает задержку в 10 секунд, поскольку условие `1=1истинно`.

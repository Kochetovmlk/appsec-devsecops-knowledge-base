...
Этого можно добиться несколькими способами. В следующих разделах показано, как злоумышленник может использовать атаки методом перебора, а также некоторые недостатки защиты от таких атак. Вы также узнаете об уязвимостях базовой аутентификации HTTP.
